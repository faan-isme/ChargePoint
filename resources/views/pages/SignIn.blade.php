...
<div class="md:ms-20 md:me-20 lg:ms-20 ms-10 me-10 lg:me-0 h-screen">
    <div class="lg:grid lg:grid-cols-2 lg:items-center lg:gap-10 lg:justify-center">
        <div class="flex flex-col">
            <div class="text-center mt-10">
                <h1 class="md:text-5xl text-3xl font-bold">Welcome to </h1>
                <h1 class="text-[#000D81] md:text-5xl text-3xl font-bold mt-2">ChargePoint</h1>
            </div>
            ...
            <div>
                ...
                <div class="flex text-center justify-center mt-5 gap-2">
                    ...
                    <a class="font-bold text-[#77049F]" href="/signup">Register</a>
                </div>
            </div>
        </div>
        <div class=" bg-[#EAEEFA] h-[100%] p-10 gap-2 hidden lg:block lg:relative">
            <img src="./assets/login/assetLogin.png" class="w-full h-full" />
        </div>
    </div>
</div>
<section>
