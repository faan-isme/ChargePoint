...
<div class="px-6 pt-3 md:px-10 md:pt-10 lg:ml-64">
    <h1 class="mb-6 text-3xl font-poppins font-bold">Check Pendaftaran</h1>
    <form class="mt-10" action="#">
        ...
        <div class="font-poppins mb-6">
            ...
            <div class="fixed inset-0 hidden items-center justify-center bg-black bg-opacity-50" id="imageModal">
        ...
        <div class="flex mt-10 md:gap-5 gap-3 mb-10">
            <button
                class="font-medium md:px-6 py-2 px-4 rounded-md bg-[#000D81] hover:bg-black text-white w-[50%]">Terima
                atau
                ACC</button>
            <button
                class="font-medium md:px-6 py-2 px-4 rounded-md bg-[#000D81] hover:bg-black text-white w-[50%]">Belum
                Lengkap</button>
        </div>
    </form>
