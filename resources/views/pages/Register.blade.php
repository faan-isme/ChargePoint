            ...
            <div>
                ...
                <form action="/register" method="post">
                    ...
                    <div class="flex flex-col">
                        ...
                        <input id="email" name="email" class="w-100 rounded-lg shadow-md p-3 border border-gray-400 mt-3" placeholder="Email" type="email" value="{{Session::get('email')}}"required />
                    </div>
                    <div class="flex flex-col mt-5">
                        <label for="username">Username</label>
                        <input id="username" name="username" class="w-100 rounded-lg shadow-md p-3 border border-gray-400 mt-3" placeholder="Username" type="text" value="{{Session::get('username')}}" required />
                    </div>
                    <div class="flex flex-col mt-5">
                        <label for="password">Password</label>
                        <input id="password" name="password" type="password" class="w-100 rounded-lg shadow-md p-3 border border-gray-400 mt-3"
                            placeholder="Password" />
                    </div>
                    <div class="flex flex-col mt-5">
                        <label for="confirm-pw">Password Confirmation</label>
                        <input id="confirm-pw" name="password_confirmation" type="password" class="w-100 rounded-lg shadow-md p-3 border border-gray-400 mt-3"
